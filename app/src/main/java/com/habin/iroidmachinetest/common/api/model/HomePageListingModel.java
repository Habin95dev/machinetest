package com.habin.iroidmachinetest.common.api.model;

import java.util.List;

public class HomePageListingModel {
    /**
     * status : success
    ...
    public static class DataBean {
        ...
        private List<FreshProductsBean> ProductsForYou;
        ...
        public List<FreshProductsBean> getProductsForYou() {
            return ProductsForYou;
        }

        public void setProductsForYou(List<FreshProductsBean> ProductsForYou) {
